...
efuse="/sys/bus/nvmem/devices/efuse0/nvmem"

[ -f "$efuse" ] || efuse="/sys/class/efuse/uuid" # Fallback on AMLogic efuse ABI

/system/bin/setprop ro.serialno $(/system/bin/cat "$efuse")
